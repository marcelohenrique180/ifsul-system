...
class ParecerInsert extends Component {

    constructor(props){
        super(props);

        this.state = {deferido: "", parecer: "", memorando: "", erro: {message: "", erro: false}};
    ...
    handleSubmit(e){
        ...
        const requerimento_link = this.props.requerimento.requerimento._links.self.href;
        ...
        if (error){
            ...
            this.props.sendParecer({deferido, parecer, memorando, requerimento: requerimento_link}).then(() => {
                ...
                <form className="form-group">
                    ...
                    <div className="form-group radio-inline-flex">
                        <div className="radio-inline">
                            <label>
                                <input type="radio" name="deferido" value="true"
                        ...
                        <div className="radio-inline">
                            <label>
                                <input type="radio" name="deferido" value="false"
                    ...
                    <Alerta show={erro.erro} alertClass="alert alert-danger" message={erro.message}/>
